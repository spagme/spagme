export interface ApiInterface {
  sbyte: (input: number, method?: string) => Promise<number>,
  sbyteNullable: (input: number | null, method?: string) => Promise<number | null>,
}

export abstract class ApiBase implements ApiInterface {
  abstract sbyte: (input: number, method?: string) => Promise<number>;
  abstract sbyteNullable: (input: number | null, method?: string) => Promise<number | null>;
}
...
export class Api implements ApiBase {
  ...
  sbyte: (input: number, method?: string)  => Promise<number> = (input: number, method?: string) : Promise<number> => {
    const data: any = {};
    data.input = JSON.stringify(input);
    if(method === 'get') return this.get(`${this.url}/sbyte`, data);
    return this.post(`${this.url}/sbyte`, data);
  }
  sbyteNullable: (input: number | null, method?: string)  => Promise<number | null> = (input: number | null, method?: string) : Promise<number | null> => {
    const data: any = {};
    data.input = JSON.stringify(input);
